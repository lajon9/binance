...
class BinanceRest {
    ...
    accountIsolatedMargin(query = {}, callback) {
        if (_.isFunction(query)) {
            callback = query;
            query = {};
        }
        this._setTimestamp(query);
        return this._makeRequest(query, callback, '/sapi/v1/margin/isolated/account', 'SIGNED');
    }
    
    allOrdersMargin(query = {}, callback) {
        if (_.isString(query)) {
            query = { symbol: query };
        }
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/margin/allOrders', 'SIGNED');
    }
    
    myTradesMargin(query = {}, callback) {
        if (_.isString(query)) {
            query = { symbol: query };
        }
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/margin/myTrades', 'SIGNED');
    }

    marginBorrow(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/margin/loan', 'SIGNED', 'GET');
    }

    marginRepay(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/margin/repay', 'SIGNED', 'GET');
    }

    marginTransfer(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/margin/transfer', 'SIGNED', 'GET');
    }
    
    interestHistory(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, '/sapi/v1/margin/interestHistory', 'SIGNED', 'GET');
    }
    
    forceLiquidationRec(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, '/sapi/v1/margin/forceLiquidationRec', 'SIGNED', 'GET');
    }
