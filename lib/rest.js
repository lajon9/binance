...
class BinanceRest {
    ...
    interestHistory(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, '/sapi/v1/margin/interestHistory', 'SIGNED', 'POST');
    }
    
    forceLiquidationRec(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, '/sapi/v1/margin/forceLiquidationRec', 'SIGNED', 'POST');
    }
